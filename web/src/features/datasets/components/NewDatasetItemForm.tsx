                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      <FormLabel>{t("datasets.editItemDialog.input")}</FormLabel>
                      {hasInputSchema &&
                        selectedDatasets
  ...
  "question": "What is the capital of England?"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      <FormLabel>{t("datasets.editItemDialog.expectedOutput")}</FormLabel>
                      {hasOutputSchema &&
                        selectedDatasets
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="mt-4 flex flex-col gap-2">
                  <FormLabel>{t("datasets.editItemDialog.metadata")}</FormLabel>
                  <FormControl>
                    <CodeMirrorEditor
                      mode="json"
                      value={field.value}

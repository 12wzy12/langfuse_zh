...
export function DatasetRunsTable(props: {
  ...
  const columns: LangfuseColumnDef<DatasetRunRowData>[] = [
    ...
    {
      accessorKey: "name",
      header: t("datasets.runsTable.name"),
      id: "name",
      size: 150,
      isFixedPosition: true,
      isPinnedLeft: true,
    ...
    },
    {
      ...
      header: t("datasets.runsTable.items"),
      id: "countRunItems",
      size: 90,
      enableHiding: true,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: t("datasets.runsTable.created"),
      id: "createdAt",
      size: 150,
      enableHiding: true,
      cell: ({ row }) => {
    ...
    },
    {
      id: "actions",
      accessorKey: "actions",
      header: t("datasets.runsTable.actions"),
      size: 70,
      cell: ({ row }) => {
        const id: DatasetRunRowData["id"] = row.getValue("id");
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-8 w-8 p-0">
                <span className="sr-only relative">{t("datasets.runsTable.openMenu")}</span>
                <MoreVertical className="h-4 w-4" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end">
              <DropdownMenuLabel>{t("datasets.runsTable.actions")}</DropdownMenuLabel>

...
export function DatasetsTable(props: { projectId: string }) {
  ...
  const columns: LangfuseColumnDef<DatasetTableRow>[] = [
    {
      accessorKey: "key",
      header: t("datasets.datasetsTable.name"),
      id: "key",
      size: 150,
    ...
    },
    {
      ...
      header: t("datasets.datasetsTable.description"),
      id: "description",
      enableHiding: true,
      size: 200,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: t("datasets.datasetsTable.items"),
      id: "countItems",
      enableHiding: true,
      size: 60,
    },
    {
      ...
      header: t("datasets.datasetsTable.runs"),
      id: "countRuns",
      enableHiding: true,
      size: 60,
    },
    {
      ...
      header: t("datasets.datasetsTable.created"),
      id: "createdAt",
      enableHiding: true,
      size: 150,
      cell: ({ row }) => {
    ...
    },
    {
      id: "actions",
      accessorKey: "actions",
      header: t("datasets.datasetsTable.actions"),
      size: 70,
      cell: ({ row }) => {
        const key: DatasetTableRow["key"] = row.getValue("key");
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-8 w-8 p-0">
                <span className="sr-only">{t("datasets.datasetsTable.openMenu")}</span>
            ...
            >
              <DropdownMenuLabel>{t("datasets.datasetsTable.actions")}</DropdownMenuLabel>

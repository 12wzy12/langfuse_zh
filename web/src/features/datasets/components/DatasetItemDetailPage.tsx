...
export const DatasetItemDetailPage = ({
  ...
  const handleDelete = () => {
    ...
    if (
      window.confirm(t("datasets.itemsTable.deleteDescription"))
    ) {
  ...
  return (
    <Page
      ...
      headerProps={{
        ...
        breadcrumb: [
          { name: t("datasets.breadcrumb.datasets"), href: `/project/${projectId}/datasets` },
          {
            ...
            {item.data?.sourceTraceId && (
              <Button variant="ghost" size="icon-xs" asChild>
                <Link
                  ...
                  title={t("datasets.itemDetailPage.viewSource")}
                >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="flex flex-col *:w-full *:justify-start">
                ...
                >
                  ...
                  {t("datasets.itemDetailPage.editItem")}
                </DropdownMenuItem>
                <DropdownMenuItem
                ...
                >
                  ...
                  {mutDelete.isPending ? t("common.loading") : t("common.delete")}
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </>

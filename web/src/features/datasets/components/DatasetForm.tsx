            ...
            {props.mode === "delete" ? (
              ...
              <div className="mb-8 space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("datasets.datasetForm.name")}</FormLabel>
                      <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("datasets.datasetForm.description")}</FormLabel>
                      <FormControl>
                        <Input {...field} />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <DatasetSchemaInput
                      label={t("datasets.datasetForm.inputSchema")}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <DatasetSchemaInput
                      label={t("datasets.datasetForm.expectedOutputSchema")}
          ...
          {props.showFooter !== false && (
            <DialogFooter>
              <div className="flex w-full flex-col gap-4">
                ...
                >
                  {props.mode === "create"
                    ? t("datasets.datasetForm.create")
                    : props.mode === "delete"
                      ? "Delete Dataset"
                      : t("datasets.datasetForm.save")}
                </Button>
                {formError && (

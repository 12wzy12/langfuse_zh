...
export function DatasetItemsTable({
  ...
  const columns: LangfuseColumnDef<RowData>[] = [
    {
      accessorKey: "id",
      header: t("datasets.itemsTable.id"),
      id: "id",
      size: 90,
    ...
    {
      accessorKey: "source",
      header: t("datasets.itemsTable.source"),
      headerTooltip: {
        description:
    ...
    },
    {
      ...
      header: t("datasets.itemsTable.date"),
      id: "createdAt",
      size: 150,
      enableHiding: true,
      cell: ({ row }) => {
    ...
    {
      accessorKey: "input",
      header: t("datasets.itemsTable.input"),
      id: "input",
      size: 200,
      enableHiding: true,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: t("datasets.itemsTable.expectedOutput"),
      id: "expectedOutput",
      size: 200,
      enableHiding: true,
      cell: ({ row }) => {
    ...
    },
    {
      id: "actions",
      accessorKey: "actions",
      header: t("datasets.itemsTable.actions"),
      size: 70,
      cell: ({ row }) => {
        const id: string = row.getValue("id");
        const status: DatasetStatus = row.getValue("status");
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-8 w-8 p-0">
                <span className="sr-only relative">{t("datasets.itemsTable.openMenu")}</span>
                <MoreVertical className="h-4 w-4" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end">
              <DropdownMenuLabel>{t("datasets.itemsTable.actions")}</DropdownMenuLabel>
              <DropdownMenuItem
              ...
              <DropdownMenuItem
                ...
                onClick={() => {
                  if (
                    window.confirm(
                      t("datasets.itemsTable.deleteDescription"),
                    )
                  ) {

    ...
    <div ref={containerRef} className="bg-muted/25 shrink-0 border-b px-3 py-2">
      <div className="flex items-center justify-start gap-2">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" size="sm" className="h-8 gap-2">
              {getResponsiveContent(t("playground.configDropdowns.tools"), Wrench)}
              {toolsCount > 0 && (
          ...
          >
            <div className="mb-3">
              <h4 className="mb-1 text-sm font-medium">{t("playground.configDropdowns.tools")}</h4>
              <p className="text-muted-foreground text-xs">
                {t("playground.configDropdowns.toolsDescription")}
              </p>
            </div>
            {toolsCount > 0 ? (
              <div className="mb-3">
              ...
              <div className="mb-3">
                <p className="text-muted-foreground text-xs">
                  {t("playground.configDropdowns.noToolsAttached")}
                </p>
              </div>
            )}
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" size="sm" className="h-8 gap-2">
              {getResponsiveContent(t("playground.configDropdowns.schema"), Braces)}
              {hasSchema > 0 && (
                <Badge variant="secondary" className="h-4 text-xs">
                  {hasSchema}
                </Badge>
          ...
          <PopoverContent className="w-80 p-4" align="start">
            <div className="mb-3">
              <h4 className="mb-1 text-sm font-medium">{t("playground.configDropdowns.structuredOutput")}</h4>
              <p className="text-muted-foreground text-xs">
                {t("playground.configDropdowns.structuredOutputDescription")}
              </p>
            </div>
            {structuredOutputSchema ? (
              <div className="mb-3">
              ...
              <div className="mb-3">
                <p className="text-muted-foreground text-xs">
                  {t("playground.configDropdowns.noSchemaProvided")}
                </p>
              </div>
            )}
            <div className="border-t pt-3">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" size="sm" className="h-8 gap-2">
              {getResponsiveContent(t("playground.configDropdowns.variablesSection"), Variable, "变量")}
              {variablesCount > 0 && (
                <Badge variant="secondary" className="h-4 text-xs">
                  {variablesCount}
                </Badge>
          ...
          <PopoverContent className="w-80 p-4" align="start">
            <div className="mb-3">
              <h4 className="mb-1 text-sm font-medium">
                {t("playground.configDropdowns.variablesSection")} & {t("playground.configDropdowns.messagePlaceholdersSection")}
              </h4>
              <p className="text-muted-foreground text-xs">
                {t("playground.configDropdowns.variablesDescription")}
              </p>
            </div>
            {variablesCount > 0 ? (
              <div
              ...
              >
                <div className="space-y-4">
                  <div>
                    <h5 className="mb-2 text-xs font-medium">{t("playground.configDropdowns.variablesSection")}</h5>
                    <Variables />
                  </div>
                  <div>
                    <h5 className="mb-2 text-xs font-medium">
                      {t("playground.configDropdowns.messagePlaceholdersSection")}
                    </h5>
                    <MessagePlaceholders />
                  </div>
                </div>
              ...
              <div className="mb-3">
                <p className="text-muted-foreground text-xs">
                  {t("playground.configDropdowns.noVariablesDefined")}
                </p>
              </div>
            )}
          </PopoverContent>

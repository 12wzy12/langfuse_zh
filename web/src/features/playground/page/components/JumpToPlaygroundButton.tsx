...
export const JumpToPlaygroundButton: React.FC<JumpToPlaygroundButtonProps> = (
  ...
  const tooltipMessage = isAvailable
    ? t("playground.jumpToPlayground.tooltipAvailable")
    : t("playground.jumpToPlayground.tooltipUnavailable");
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          />
          {t("playground.jumpToPlayground.button")}
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuItem onClick={() => handlePlaygroundAction(true)}>
          ...
          {t("playground.jumpToPlayground.freshPlayground")}
</DropdownMenuItem>
        <DropdownMenuItem onClick={() => handlePlaygroundAction(false)}>
          <Terminal className="mr-2 h-4 w-4" />
          {t("playground.jumpToPlayground.addToExisting")}
        </DropdownMenuItem>
        {props.source === "generation" && (
          <>
            <DropdownMenuSeparator />
            <div className="flex items-center justify-between px-2 py-1.5">
              <span className="text-sm">{t("playground.jumpToPlayground.includeOutput")}</span>
              <Switch

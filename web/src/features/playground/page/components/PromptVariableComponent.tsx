...
export const PromptVariableComponent: React.FC<{
  ...
  const isUsedTooltip = isUsed
    ? t("playground.variables.variableInUse")
    : t("playground.variables.variableNotInUse");
    ...
    <div className="p-1">
      <div className="mb-1 flex flex-row items-center">
        ...
        <Button
          variant="ghost"
          size="icon"
          title={t("playground.variables.deleteVariable")}
          disabled={isUsed}
      ...
      {hasConflict && (
        <p className="mt-1 text-xs text-red-500">
          {t("playground.variables.conflictError")}
        </p>
      )}
    </div>
  );

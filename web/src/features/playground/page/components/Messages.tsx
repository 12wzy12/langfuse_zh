  ...
  return (
    <div className="flex items-center gap-2">
      <Button
        ...
        loading={isStreaming}
      >
        <p>{t("playground.messages.submit")}</p>
      </Button>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-52">
          ...
          >
            <div className="flex flex-col">
              <span>{t("playground.messages.streamResponses")}</span>
              <span className="text-muted-foreground text-xs">
                {streamingEnabled
                  ? t("playground.messages.streamRealTime")
                  : t("playground.messages.streamComplete")}
              </span>
            </div>
            <Switch

                ...
                <>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <Plus size={14} />
                        <span className="sr-only">{t("playground.header.newSplitWindow")}</span>
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent className="text-xs">
                      {t("playground.header.newSplitWindow")}
                    </TooltipContent>
                  </Tooltip>
                  <Button
                    variant="outline"
                  ...
                  >
                    <Plus size={14} />
                    <span>{t("playground.header.newSplitWindow")}</span>
                  </Button>
                </>
              )}
              {canRemove && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      <X size={14} />
                      <span className="sr-only">{t("playground.header.removeWindow")}</span>
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent className="text-xs">
                    {t("playground.header.removeWindow")}
                  </TooltipContent>
                </Tooltip>
              )}
            </TooltipProvider>

...
export const CreateNewAnnotationQueueItem = ({
  ...
  return (
    ...
    >
      ...
      <DropdownMenuContent>
        <DropdownMenuLabel>{t("annotationQueues.createNewItem.inQueues")}</DropdownMenuLabel>
        {queues.data?.queues.length ? (
          ...
          >
            {t("annotationQueues.createNewItem.noQueues")}
          </DropdownMenuItem>
        )}
        <DropdownMenuSeparator />
        <DropdownMenuItem
        ...
        >
          <div>
            ...
            <Link href={`/project/${projectId}/annotation-queues`}>
              {t("annotationQueues.createNewItem.manageQueues")}
            </Link>
          </div>
        </DropdownMenuItem>
      </DropdownMenuContent>

...
export function AnnotationQueuesTable({ projectId }: { projectId: string }) {
  ...
  const columns: LangfuseColumnDef<RowData>[] = [
    {
      accessorKey: "key",
      header: t("annotationQueues.queuesTable.name"),
      id: "key",
      size: 150,
      isPinnedLeft: true,
    ...
    },
    {
      ...
      header: t("annotationQueues.queuesTable.description"),
      id: "description",
      enableHiding: true,
      size: 200,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: t("annotationQueues.queuesTable.completedItems"),
    ...
    },
    {
      ...
      header: t("annotationQueues.queuesTable.pendingItems"),
    ...
    },
    {
      ...
      header: t("annotationQueues.queuesTable.scoreConfigs"),
      id: "scoreConfigs",
      enableHiding: true,
      size: 200,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: t("annotationQueues.queuesTable.created"),
      id: "createdAt",
      enableHiding: true,
      size: 150,
    },
    {
      ...
      header: t("annotationQueues.queuesTable.process"),
      id: "processAction",
      isFixedPosition: true,
      cell: ({ row }) => {
        const key: RowData["key"] = row.getValue("key");
        return !hasAccess ? (
          <Button size="sm" disabled>
            ...
            <span className="text-xs">{t("annotationQueues.queuesTable.processQueue")}</span>
          </Button>
        ) : (
    ...
    {
      accessorKey: "actions",
      header: t("annotationQueues.queuesTable.actions"),
      id: "actions",
      size: 70,
      isFixedPosition: true,
      cell: ({ row }) => {
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-8 w-8 p-0">
                <span className="sr-only">{t("annotationQueues.queuesTable.openMenu")}</span>
                <MoreVertical className="h-4 w-4" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end">
              <DropdownMenuLabel>{t("annotationQueues.queuesTable.actionsDropdown")}</DropdownMenuLabel>

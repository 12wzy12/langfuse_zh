  ...
  const createEvalTemplateMutation = api.evals.createTemplate.useMutation({
    onSuccess: () => {
      ...
      if (
        ...
        showSuccessToast({
          title: t("evals.templateForm.updatedEvalsToast"),
          description: t("evals.templateForm.updatedEvalsDesc"),
        });
      }
    },
    ...
    <>
              ...
              render={({ field }) => (
                <>
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder={t("evals.templateForm.namePlaceholder")} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                </>
      ...
      {showCodeTemplateForm ? (
        ...
        <>
          ...
          <Card>
            <CardContent>
              <p className="my-2 font-semibold">{t("evals.templateForm.model")}</p>
              <FormField
                control={form.control}
                ...
                render={({ field }) => (
                  <FormItem className="mt-3 flex flex-row items-center space-y-0 space-x-3">
                    ...
                    <div className="space-y-0 leading-none">
                      <FormLabel>{t("evals.templateForm.useDefaultModel")}</FormLabel>
                  ...
                  <ModelParameters
                    customHeader={
                      <p className="text-sm leading-none font-medium">
                        {t("evals.templateForm.customModel")}
                      </p>
                    }
                    {...{
                      modelParams,
          ...
          <Card>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                <p className="my-2 font-semibold">{t("evals.templateForm.prompt")}</p>
                <FormField
                  control={form.control}
                  name="prompt"
                  render={({ field }) => (
                    <>
                      <FormItem>
                        <FormLabel>{t("evals.templateForm.prompt")}</FormLabel>
                        <FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t("evals.templateForm.scoreDataType")}</FormLabel>
                    <FormDescription>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value={ScoreDataTypeEnum.NUMERIC}>
                          {t("evals.templateForm.numeric")}
                        </SelectItem>
                        <SelectItem value={ScoreDataTypeEnum.BOOLEAN}>
                          {t("evals.templateForm.boolean")}
                        </SelectItem>
                        <SelectItem value={ScoreDataTypeEnum.CATEGORICAL}>
                          {t("evals.templateForm.categorical")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <FormLabel className="text-muted-foreground text-xs">
                                    {t("evals.templateForm.categoryValue")}
                                  </FormLabel>
                                  <FormControl>
                                    <Input {...field} />
                                  </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="mt-3 flex flex-row items-center space-y-0 space-x-3">
                            ...
                            <div className="space-y-0.5 leading-none">
                              <FormLabel>{t("evals.templateForm.allowMultiple")}</FormLabel>
                              <FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t("evals.templateForm.reasoningDescription")}</FormLabel>
                    <FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t("evals.templateForm.scoreDescription")}</FormLabel>
                    <FormDescription>
                      {isCategoricalOutput
                        ? shouldAllowMultipleMatches

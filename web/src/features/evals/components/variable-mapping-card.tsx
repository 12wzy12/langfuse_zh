  ...
  return (
    <Card className="max-w-full min-w-0 p-4">
      <div className="mb-2 flex items-center gap-2">
        <span className="text-lg font-medium">{t("evals.variableMapping.title")}</span>
                        ...
                        <Card className="flex flex-col gap-2 p-4" key={index}>
                            ...
                            render={({ field }) => (
                              <div className="flex items-center gap-2">
                                <VariableMappingDescription
                                  title={t("evals.variableMapping.langfuseObject")}
                                  description={
                            ...
                            <FormField
                              ...
                              render={({ field }) => {
                                ...
                                return (
                                  <div className="flex items-center gap-2">
                                    <VariableMappingDescription
                                      title={t("evals.variableMapping.objectName")}
                                      description={
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <div className="flex items-center gap-2">
                                <VariableMappingDescription
                                  title={t("evals.variableMapping.selectedColumn")}
                                  description={
                          ...
                          {fieldHasJsonSelectorOption(
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <div className="flex items-center gap-2">
                                  <VariableMappingDescription
                                    title={t("evals.variableMapping.jsonSelector")}
                                    description={

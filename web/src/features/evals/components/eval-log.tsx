...
export default function EvalLogTable({
  ...
  const columns = [
    ...
    columnHelper.accessor("startTime", {
      id: "startTime",
      header: t("evals.log.startTime"),
      enableHiding: true,
    }),
    columnHelper.accessor("endTime", {
      id: "endTime",
      header: t("evals.log.endTime"),
      enableHiding: true,
    }),
    columnHelper.accessor("scoreName", {
      header: t("evals.log.scoreName"),
      id: "scoreName",
      enableHiding: true,
    }),
    columnHelper.accessor("scoreValue", {
      header: t("evals.log.scoreValue"),
      id: "scoreValue",
      enableHiding: true,
      cell: (row) => {
    ...
    columnHelper.accessor("scoreComment", {
      header: t("evals.log.scoreComment"),
      id: "scoreComment",
      enableHiding: true,
      cellPadding: "none",
      loadingCell: () => (
    ...
    columnHelper.accessor("traceId", {
      id: "traceId",
      header: t("evals.log.targetTrace"),
      cell: (row) => {
    ...
    columnHelper.accessor("executionTraceId", {
      id: "executionTraceId",
      header: t("evals.log.executionTrace"),
      enableHiding: true,
      cell: (row) => {
        const traceId = row.getValue();
        return traceId ? (

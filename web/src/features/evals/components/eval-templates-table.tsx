  ...
  if (type === EvalTemplateType.CODE) {
    const label =
      sourceCodeLanguage === EvalTemplateSourceCodeLanguage.PYTHON
        ? t("evals.templates.language.python")
        : sourceCodeLanguage === EvalTemplateSourceCodeLanguage.TYPESCRIPT
          ? t("evals.templates.language.typescript")
          : t("evals.templates.language.code");
...
export default function EvalsTemplateTable({
  ...
  const createEvalTemplateMutation = api.evals.createTemplate.useMutation({
    onSuccess: () => {
      ...
      showSuccessToast({
        title: t("evals.templates.clonedSuccessfully"),
        description:
          t("evals.templates.clonedDescription"),
      });
    },
    onError: (error) => {
      showErrorToast(t("evals.templates.cloneError"), error.message);
    },
  });
  ...
  const columns = [
    ...
    columnHelper.accessor("resultType", {
      id: "resultType",
      header: t("evals.table.scoreResultType"),
      size: 120,
      cell: (row) => {
    ...
    columnHelper.accessor("maintainer", {
      id: "maintainer",
      header: t("evals.table.maintainer"),
      size: 150,
      cell: (row) => {
        return (
    ...
    columnHelper.accessor("latestCreatedAt", {
      header: t("evals.table.lastEdited"),
      id: "latestCreatedAt",
      size: 80,
      cell: (row) => {
    ...
    columnHelper.accessor("usageCount", {
      header: t("evals.table.usageCount"),
      id: "usageCount",
      enableHiding: true,
      size: 80,
      cell: (row) => {
    ...
    columnHelper.accessor("latestVersion", {
      header: t("evals.table.latestVersion"),
      id: "latestVersion",
      enableHiding: true,
      size: 80,
      cell: (row) => {
        ...
        return (
          <div className="flex flex-row items-center gap-2">
            <ActionButton
              ...
              title={
                isInvalid
                  ? t("evals.templates.invalidModel.title")
                  : undefined
              }
              hasAccess={hasAccess}
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon-xs" aria-label="actions">
                    <span className="sr-only relative">{t("evals.templates.openMenu")}</span>
  ...
  return (
    <>
        ...
        >
          ...
          <EvalTemplateForm
            ...
            onFormSuccess={() => {
              ...
              utils.evals.templateNames.invalidate();
              showSuccessToast({
                title: t("evals.templates.updatedSuccessfully"),
                description: t("evals.templates.nowUsable"),
              });
            }}
          />
        </DialogContent>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("evals.templates.updateRunningEvaluators")}</DialogTitle>
            <DialogDescription>
              {t("evals.templates.updateRunningEvaluatorsDesc.line1")}
              <br />
              <br />
              <strong>{t("evals.templates.updateRunningEvaluatorsDesc.warning")}:</strong>{" "}
              {t("evals.templates.updateRunningEvaluatorsDesc.warningText")}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button

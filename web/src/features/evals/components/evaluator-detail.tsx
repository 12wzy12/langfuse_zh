...
export const EvaluatorDetail = () => {
  ...
  if (
    ...
    return <div className="p-3">{t("evals.detail.loading")}</div>;
  }
    ...
    <Page
      headerProps={{
        title: evaluator.data
          ...
          : t("evals.detail.loading"),
        itemType: "EVALUATOR",
        breadcrumb: [
          {
            name: t("evals.detail.breadcrumb"),
          ...
          {filterValidation && !filterValidation.isValid && (
            <div className="mx-3 mt-3">
              <Alert variant="destructive">
                ...
                <AlertTitle>{t("evals.detail.unsupportedFilters")}</AlertTitle>
                <AlertDescription>
                  {t("evals.detail.unsupportedFiltersDescription")}{" "}
                </AlertDescription>
              </Alert>
            </div>
          )}

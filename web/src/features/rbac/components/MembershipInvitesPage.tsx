...
export function MembershipInvitesPage({
  ...
  const columns: LangfuseColumnDef<InvitesTableRow>[] = [
    {
      accessorKey: "email",
      id: "email",
      header: t("settings.memberInvites.email"),
    },
    {
      accessorKey: "orgRole",
      id: "orgRole",
      header: t("settings.memberInvites.orgRole"),
    },
    {
      accessorKey: "createdAt",
      id: "createdAt",
      header: t("settings.memberInvites.invitedOn"),
      cell: ({ row }) => {
      ...
      ? [
          {
            ...
            id: "projectRole",
            header: t("settings.memberInvites.projectRole"),
          },
        ]
      : []),
    {
      ...
      id: "invitedByUser",
      header: t("settings.memberInvites.invitedBy"),
      cell: ({ row }) => {
    ...
    },
    {
      accessorKey: "meta",
      id: "meta",
      header: t("settings.memberInvites.actions"),
      cell: ({ row }) => {
        ...
        return hasCudAccess ? (
          <div className="flex space-x-2">
            <button
              onClick={() => {
                if (confirm(t("settings.memberInvites.cancelConfirm"))) {
  ...
  return (
    <>
      ...
      <Header title={t("settings.memberInvites.title")} />

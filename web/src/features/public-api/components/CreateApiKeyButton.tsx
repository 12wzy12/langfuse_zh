  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent onPointerDownOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle>
            {generatedKeys ? t("settings.apiKeys.secretKey") : t("settings.apiKeys.createTitle")}
          </DialogTitle>
        </DialogHeader>
        <DialogBody>
          {generatedKeys ? (
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="note">{t("settings.apiKeys.noteLabel")}</Label>
                <Input
                  id="note"
                  placeholder={t("settings.apiKeys.notePlaceholder")}
                  value={note}
...
export const ApiKeyRender = ({
  ...
  return (
    <div className={cn("space-y-6", className)}>
      <div>
        <SubHeader title={t("settings.apiKeys.secretKeySection")} />
        <div className="text-muted-foreground text-sm">
          {t("settings.apiKeys.secretKeyDescription", { scope })}
        </div>
        <CodeView
      ...
      <div>
        <SubHeader title={t("settings.apiKeys.publicKeySection")} />
        <CodeView
      ...
      <div>
        <SubHeader title={t("settings.apiKeys.envTitle")} />

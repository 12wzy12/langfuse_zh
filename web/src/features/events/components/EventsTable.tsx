...
export default function ObservationsEventsTable({
  ...
  const traceDeleteMutation = api.traces.deleteMany.useMutation({
    onSuccess: () => {
      showSuccessToast({
        title: t("tracing.events.deletedTitle"),
        description: t("tracing.events.deletedDescription"),
      });
    },
    onSettled: () => {
      utils.events.all.invalidate();
  ...
  const tableActions: TableAction[] = [
      ...
      ? [
          {
            ...
            label: t("tracing.events.deleteTraces"),
            description:
              "此操作会永久删除这些 Trace 中的全部 Observation 以及 Trace 本身，即使你当前只选中了单个 Observation。该操作无法撤销，Trace 删除会异步执行，最多可能需要 24 小时。",
            disabled: selectAll || selectedTraceIds.length === 0,
            disabledReason: selectAll
              ? "删除 Trace 仅适用于当前页面选中的 Observation。"
              : "所选 Observation 缺少 trace ID。",
            accessCheck: {
              scope: "traces:delete",
      ...
      : []),
    {
      ...
      label: t("tracing.events.addToAnnotationQueue"),
      description: t("tracing.events.addToAnnotationQueueDescription"),
      targetLabel: t("tracing.list.annotationQueue"),
    ...
    },
    {
      ...
      type: BatchActionType.Create,
      label: t("tracing.events.addToDataset"),
      description: t("tracing.events.addToDatasetDescription"),
      customDialog: true,
      accessCheck: {
        scope: "datasets:CUD",
      },
    },
    {
      ...
      type: BatchActionType.Create,
      label: t("tracing.events.evaluate"),
      description: t("tracing.events.evaluateDescription"),
      customDialog: true,
  ...
  const columns: LangfuseColumnDef<EventsTableRow>[] = [
    ...(hideControls ? [] : [selectActionColumn]),
    {
      ...
      id: "startTime",
      header: getEventsColumnName("startTime", t),
      size: 150,
      enableHiding: true,
      enableSorting,
      cell: ({ row }) => {
    ...
    },
    {
      accessorKey: "type",
      id: "type",
      header: getEventsColumnName("type", t),
      size: 50,
    ...
    },
    {
      accessorKey: "name",
      id: "name",
      header: getEventsColumnName("name", t),
      size: 150,
      enableSorting,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      id: "traceName",
      header: getEventsColumnName("traceName", t),
      size: 150,
      enableSorting: true,
      cell: ({ row }) => {
    ...
    {
      accessorKey: "input",
      header: getEventsColumnName("input", t),
      id: "input",
      size: 300,
      loadingCell: () => (
        <JsonSkeleton
    ...
    },
    {
      accessorKey: "output",
      id: "output",
      header: getEventsColumnName("output", t),
      size: 300,
      loadingCell: () => (
        <JsonSkeleton
          numRows={rowHeight === "s" ? 1 : undefined}
    ...
    },
    {
      ...
      header: t("tracing.events.metadata"),
      size: 300,
      loadingCell: () => (
        <JsonSkeleton
          numRows={rowHeight === "s" ? 1 : undefined}
      ...
      headerTooltip: {
        description: t("tracing.events.metadataDescription"),
    ...
    },
    {
      accessorKey: "level",
      id: "level",
      header: getEventsColumnName("level", t),
      size: 100,
      headerTooltip: {
        description:
    ...
    },
    {
      ...
      header: getEventsColumnName("statusMessage", t),
      id: "statusMessage",
      size: 150,
      headerTooltip: {
        description:
    ...
    },
    {
      accessorKey: "latency",
      id: "latency",
      header: getEventsColumnName("latency", t),
      size: 100,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: getEventsColumnName("totalCost", t),
      id: "totalCost",
      size: 120,
      cell: ({ row }) => {
      ...
      columns: [
        {
          ...
          id: "inputCost",
          header: getEventsColumnName("inputCost", t),
          size: 120,
        ...
        },
        {
          ...
          id: "outputCost",
          header: getEventsColumnName("outputCost", t),
          size: 120,
          loadingCell: <TableTextLoadingCell />,
          cell: ({ row }) => {
            const value = row.getValue("cost") as {
    ...
    },
    {
      ...
      id: "toolDefinitions",
      header: getEventsColumnName("toolDefinitions", t),
      size: 120,
      enableHiding: true,
      enableSorting,
      defaultHidden: true,
    ...
    },
    {
      ...
      id: "toolCalls",
      header: getEventsColumnName("toolCalls", t),
      size: 100,
      enableHiding: true,
      enableSorting,
      defaultHidden: true,
    ...
    },
    {
      ...
      id: "timeToFirstToken",
      header: getEventsColumnName("timeToFirstToken", t),
      size: 150,
      enableHiding: true,
      enableSorting,
      cell: ({ row }) => {
      ...
      columns: [
        {
          ...
          id: "tokensPerSecond",
          header: t("tracing.events.tokensPerSecond"),
          size: 200,
          cell: ({ row }) => {
            const latency: number | undefined = row.getValue("latency");
        ...
        },
        {
          ...
          id: "inputTokens",
          header: getEventsColumnName("inputTokens", t),
          size: 100,
          loadingCell: <TableTextLoadingCell />,
          enableHiding: true,
          defaultHidden: true,
        ...
        },
        {
          ...
          id: "outputTokens",
          header: getEventsColumnName("outputTokens", t),
          size: 100,
          loadingCell: <TableTextLoadingCell />,
          enableHiding: true,
          defaultHidden: true,
        ...
        },
        {
          ...
          id: "totalTokens",
          header: getEventsColumnName("totalTokens", t),
          size: 100,
          loadingCell: <TableTextLoadingCell />,
          enableHiding: true,
          defaultHidden: true,
    ...
    },
    {
      ...
      header: getEventsColumnName("providedModelName", t),
      size: 150,
      enableHiding: true,
      enableSorting,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      id: "promptName",
      header: getEventsColumnName("promptName", t),
      headerTooltip: {
        description: t("tracing.events.promptNameDescription"),
    ...
    },
    {
      ...
      header: getEventsColumnName("environment", t),
      id: "environment",
      size: 150,
      enableHiding: true,
    ...
    },
    {
      ...
      id: "traceTags",
      header: getEventsColumnName("traceTags", t),
      size: 250,
      enableHiding: true,
      loadingCell: <TableTextLoadingCell />,
      cell: ({ row }) => {
    ...
    {
      accessorKey: "scores",
      header: t("tracing.events.scores"),
      id: "scores",
      enableHiding: true,
      defaultHidden: true,
      cell: () => {
    ...
    },
    {
      ...
      header: t("tracing.events.traceScores"),
      id: "traceScores",
      enableHiding: true,
      defaultHidden: true,
      cell: () => {
    ...
    },
    {
      accessorKey: "endTime",
      id: "endTime",
      header: getEventsColumnName("endTime", t),
      size: 150,
      enableHiding: true,
      enableSorting,
      defaultHidden: true,
    ...
    },
    {
      accessorKey: "traceId",
      id: "traceId",
      header: getEventsColumnName("traceId", t),
      size: 100,
      cell: ({ row }) => {
    ...
    },
    {
      accessorKey: "modelId",
      id: "modelId",
      header: getEventsColumnName("modelId", t),
      size: 100,
      enableHiding: true,
      defaultHidden: true,
    },
    {
      accessorKey: "version",
      id: "version",
      header: getEventsColumnName("version", t),
      size: 100,
      headerTooltip: {
        description: t("tracing.events.versionDescription"),
    ...
    },
    {
      accessorKey: "userId",
      id: "userId",
      header: getEventsColumnName("userId", t),
      size: 150,
      enableHiding: true,
      defaultHidden: true,
    },
    {
      ...
      id: "sessionId",
      header: getEventsColumnName("sessionId", t),
      size: 150,
      enableHiding: true,
      defaultHidden: true,
    },

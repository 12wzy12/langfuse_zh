        ...
        .map((project) => (
          <Card key={project.id}>
            ...
            {!project.deletedAt ? (
              <CardFooter className="gap-2">
                <Button asChild variant="secondary">
                  <Link href={`/project/${project.id}`}>
                    {t("home.organizations.goToProject")}
                  </Link>
                </Button>
              ...
              <CardContent>
                <CardDescription>
                  {t("home.organizations.projectDeleting")}
                </CardDescription>
              </CardContent>
            )}
          </Card>
...
const DemoOrganizationTile = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{t("home.organizations.tryDemo")}</CardTitle>
      </CardHeader>
      <CardContent>{t("home.organizations.demoDescription")}</CardContent>
      <CardFooter>
        <Button asChild variant="secondary">
          <Link
          ...
          >
            {t("home.organizations.viewDemoProject")}
          </Link>
        </Button>
      </CardFooter>
    </Card>
      ...
      {createProjectAccess ? (
        <Button asChild variant={primaryButtonVariant}>
          <Link href={createProjectRoute(orgId)}>
            ...
            {t("home.organizations.newProject")}
          </Link>
        </Button>
      ) : (
...
const SingleOrganizationPage = ({
  ...
  if (isDemoOrg) {
    return (
      <ContainerPage
        headerProps={{
          title: t("home.organizations.demoOrganization"),
        }}
      >
  ...
  return (
    <ContainerPage
      headerProps={{
        title: org?.name ?? t("home.organizations.organizationFallback"),
  ...
  return (
    <ContainerPage
      headerProps={{
        ...
        help: {
          description: t("home.organizations.description"),
          href: "https://langfuse.com/docs/rbac",
        },
        breadcrumb: [
          {
            name: t("home.organizations.breadcrumb"),
            href: "/",
          },
        ],
        actionButtonsRight: (
          <>
            <Input
              ...
              placeholder={t("home.organizations.searchProjects")}
            ...
            {canCreateOrg && (
              <Button data-testid="create-organization-btn" asChild>
                <Link href={createOrganizationRoute}>
                  ...
                  {t("home.organizations.newOrganization")}
                </Link>
              </Button>
            )}
          </>
    ...
    <Card className="mt-5">
      <CardHeader>
        <CardTitle data-testid="create-new-project-title">
          {t("home.organizations.getStarted")}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <CardDescription>
          {canCreateOrgs
            ? t("home.organizations.createOrgToGetStarted")
            : t("home.organizations.needInvite")}
        </CardDescription>
      </CardContent>

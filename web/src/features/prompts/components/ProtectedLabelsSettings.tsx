...
export default function ProtectedLabelsSettings({
  ...
  return (
    <div>
      <Header title={t("settings.project.protectedPromptLabels")} />
      <Card className="mb-4 p-3">
        <p className="text-primary mb-4 text-sm">
          {t("settings.protectedLabels.description")}
        </p>
              ...
              {hasAccess && hasEntitlement && (
                <Button
                  ...
                  onClick={() => {
                    if (
                      confirm(
                        t("settings.protectedLabels.removeConfirm", { label }),
                      )
                    ) {
        ...
        <Form {...form}>
          ...
          >
                  ...
                  <Popover open={open} onOpenChange={setOpen}>
                    <PopoverTrigger asChild>
                      <FormControl>
                        ...
                        >
                          {field.value || t("settings.protectedLabels.selectOrEnter")}
                    ...
                    <PopoverContent className="w-full p-0">
                      <Command>
                        <CommandInput
                          placeholder={t("settings.protectedLabels.searchOrEnter")}
                          onValueChange={(value) => {
                            field.onChange(value);
                          }}
                        />
                        <CommandEmpty>{t("settings.protectedLabels.noLabelFound")}</CommandEmpty>
                        <CommandGroup>
            ...
            >
              {t("settings.protectedLabels.add")}
            </ActionButton>
          </form>
        </Form>
      </Card>

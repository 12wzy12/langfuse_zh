...
export function PromptTable() {
  ...
  const promptColumns: LangfuseColumnDef<PromptTableRow>[] = [
    ...
    {
      accessorKey: "version",
      header: t("prompts.list.versions"),
      id: "version",
      enableSorting: true,
      size: 70,
      cell: ({ getValue, row }) => {
    ...
    },
    {
      ...
      header: t("prompts.list.latestVersionCreatedAt"),
      id: "createdAt",
      enableSorting: true,
      size: 200,
      cell: ({ getValue, row }) => {
    ...
    },
    {
      ...
      header: t("prompts.list.numberOfObservations7d"),
        ...
        <DataTableToolbar
          ...
          searchConfig={{
            ...
            customDropdownLabels: {
              metadata: t("prompts.list.searchMetadata"),
              fullText: t("prompts.list.searchFullText"),
            },

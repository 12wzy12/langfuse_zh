...
export const ModelUsageChart = ({
  ...
  const data = [
    {
      tabTitle: t("home.dashboard.charts.costByModel"),
      data: costByModel,
      totalMetric: costFormatter(totalCost),
      metricDescription: t("home.dashboard.charts.cost"),
      chartMetricLabel: t("home.dashboard.charts.usd"),
      chartUnit: "USD",
    },
    {
      tabTitle: t("home.dashboard.charts.costByType"),
      data: costByType,
      totalMetric: costFormatter(totalCost),
      metricDescription: t("home.dashboard.charts.cost"),
      chartMetricLabel: t("home.dashboard.charts.usd"),
    ...
    {
      tabTitle: t("home.dashboard.charts.usageByModel"),
      data: unitsByModel,
      totalMetric: totalTokens
        ? compactNumberFormatter(totalTokens)
        : compactNumberFormatter(0),
      metricDescription: t("home.dashboard.charts.units"),
      chartMetricLabel: t("home.dashboard.charts.tokens"),
      chartUnit: "tokens",
    },
    {
      tabTitle: t("home.dashboard.charts.usageByType"),
      data: unitsByType,
      totalMetric: totalTokens
        ? compactNumberFormatter(totalTokens)
        : compactNumberFormatter(0),
  ...
  return (
    <DashboardCard
      className={className}
      title={t("home.dashboard.charts.modelUsage")}
      isLoading={

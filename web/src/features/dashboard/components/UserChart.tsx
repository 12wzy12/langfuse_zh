...
export const UserChart = ({
        ...
        .map((item) => {
          return {
            name:
              ...
              t("home.dashboard.charts.unknown"),
  ...
  const data = [
    {
      tabTitle: t("home.dashboard.charts.tokenCost"),
      data: isExpanded
      ...
      metricDescription: t("home.dashboard.charts.totalCost"),
      chartMetricLabel: t("home.dashboard.charts.usd"),
      chartUnit: "USD",
    },
    {
      tabTitle: t("home.dashboard.charts.countOfTraces"),
      data: isExpanded
      ...
      metricDescription: t("home.dashboard.charts.totalTraces"),
  ...
  return (
    <DashboardCard
      className={className}
      title={t("home.dashboard.charts.userConsumption")}
            ...
            content: (
              <>
                {item.data.length > 0 ? (
                  ...
                  <NoDataOrLoading
                    isLoading={isLoading || user.isPending}
                    description={t("home.dashboard.charts.userNoData")}
      ...
      <ExpandListButton
        ...
        expandText={
          transformedCost.length > maxNumberOfEntries.expanded
            ? t("home.dashboard.charts.showTop", {
                count: maxNumberOfEntries.expanded,
              })
            : t("home.dashboard.charts.showAll")
        }
      />
    </DashboardCard>
  );

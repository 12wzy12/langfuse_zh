  ...
  return (
    <>
      <DashboardCard
        ...
        title={t("home.dashboard.charts.traceLatencyPercentiles")}
        isLoading={isLoading || tracesLatencies.isPending}
      >
        <DashboardTable
          headers={[
            t("home.dashboard.charts.traceName"),
      ...
      <DashboardCard
        className="col-span-1 xl:col-span-2"
        title={t("home.dashboard.charts.generationLatencyPercentiles")}
        isLoading={isLoading || generationsLatencies.isPending}
      >
        <DashboardTable
          headers={[
            t("home.dashboard.charts.generationName"),
            <RightAlignedCell key="p50">p50</RightAlignedCell>,
            <RightAlignedCell key="p90">p90</RightAlignedCell>,
            <RightAlignedCell key="p95">
              p95<span className="ml-1">▼</span>
      ...
      <DashboardCard
        className="col-span-1 xl:col-span-2"
        title={t("home.dashboard.charts.observationLatencyPercentiles")}
        isLoading={isLoading || observationsLatencies.isPending}
      >
        <DashboardTable
          headers={[
            t("home.dashboard.charts.observation"),
            <RightAlignedCell key="p50">p50</RightAlignedCell>,
            <RightAlignedCell key="p90">p90</RightAlignedCell>,
            <RightAlignedCell key="p95">
              p95<span className="ml-1">▼</span>

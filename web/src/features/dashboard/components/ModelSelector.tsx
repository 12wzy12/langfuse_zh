  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-56 p-0">
        <InputCommand>
          <InputCommandInput
            placeholder={t("home.dashboard.charts.searchModels")}
            variant="bottom"
          />
          <InputCommandEmpty>
            {t("home.dashboard.charts.noModelFound")}
          </InputCommandEmpty>
          <InputCommandGroup>
            <InputCommandItem onSelect={handleSelectAll}>
              ...
              <span>
                <p className="font-semibold">
                  {t("home.dashboard.charts.selectAll")}
                </p>
              </span>
            </InputCommandItem>
              ...
              {allModels.map((model) => (
                ...
                >
                  ...
                  {!model.model || model.model === "" ? (
                    <i>{t("home.dashboard.charts.none")}</i>
                  ) : (
                    model.model
                  )}
                </InputCommandItem>
...
export const useModelSelection = (
  ...
  const buttonText = isAllSelected
    ? t("home.dashboard.charts.allModels")
    : t("home.dashboard.charts.selected", {

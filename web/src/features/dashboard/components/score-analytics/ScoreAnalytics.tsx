...
export function ScoreAnalytics(props: {
  ...
  return (
    <DashboardCard
      ...
      title={t("home.dashboard.charts.scoresAnalytics")}
      description={t("home.dashboard.charts.scoresAnalyticsDescription")}
      ...
      headerChildren={
        ...
        Boolean(scoreKeysAndProps.data?.scoreColumns.length) && (
          <MultiSelectKeyValues
            placeholder={t("home.dashboard.charts.searchScore")}
      ...
      Boolean(scoreAnalyticsValues.length) ? (
              ...
              <div key={scoreKey}>
                ...
                <div className="mt-2 grid gap-2 lg:grid-cols-2 lg:gap-4">
                  ...
                  <div>
                    <div className="text-muted-foreground mb-2 text-sm">
                      {isNumericDataType(dataType)
                        ? t("home.dashboard.charts.movingAverageOverTime")
                        : t("home.dashboard.charts.scoresOverTime")}
                    </div>
                    {isCategoricalDataType(dataType) && (
                      <CategoricalScoreChart
                        projectId={props.projectId}
        ...
        <div className="flex min-h-36 w-full flex-1 items-center justify-center rounded-md border">
          <p className="text-muted-foreground">
            {t("home.dashboard.charts.selectScoreToViewAnalytics")}
          </p>
        </div>
      ) : (

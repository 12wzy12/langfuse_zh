...
export const ScoresTable = ({
  ...
  if (!zeroValueScores || !oneValueScores) {
    return (
      <DashboardCard
        title={t("home.dashboard.charts.scores")}
        isLoading={false}
      >
  ...
  return (
    ...
    >
      <DashboardTable
        ...
        noDataProps={{
          description: t("home.dashboard.charts.scoresNoData"),
          href: "https://langfuse.com/docs/evaluation/overview",
        }}
      >
        <TotalMetric
          metric={totalScores ? compactNumberFormatter(totalScores) : "0"}
          description={t("home.dashboard.charts.totalScoresTracked")}
        />
      </DashboardTable>
    </DashboardCard>
  );

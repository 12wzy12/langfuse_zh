...
export default function ScoresAnalyticsV2Page() {
  ...
  return (
    <Page
      headerProps={{
        title: t("scores.analytics.title"),
        breadcrumb: [{ name: t("scores.analytics.title"), href: `/project/${projectId}/scores` }],
        help: {
          ...
          {hasError ? (
            <div className="bg-destructive/10 flex flex-col items-center justify-center gap-4 rounded-lg border p-12">
              ...
              <div className="text-center">
                <h3 className="text-lg font-semibold">{t("scores.analytics.errorTitle")}</h3>
                <p className="text-muted-foreground mt-2 text-sm">
                  {t("scores.analytics.errorDescription")}
                </p>
                </div>
            </div>
          ) : hasNoScores ? (
            <div className="bg-muted/20 flex flex-col items-center justify-center gap-4 rounded-lg border p-12">
              ...
              <div className="text-center">
                <h3 className="text-lg font-semibold">{t("scores.analytics.noScoresTitle")}</h3>
                <p className="text-muted-foreground mt-2 text-sm">
            ...
            <div className="bg-muted/20 flex flex-col items-center justify-center gap-6 rounded-lg border p-12">
              ...
              <div className="max-w-2xl text-center">
                <h3 className="text-2xl font-semibold">{t("scores.analytics.selectScoreTitle")}</h3>
                ...
                <div className="text-muted-foreground mt-6 space-y-3 text-sm">
                  <div className="bg-background/50 rounded-lg p-4">
                    <p className="text-foreground mb-1 font-semibold">
                      {t("scores.analytics.singleScoreSelected")}
                    </p>
                    <p>{t("scores.analytics.singleScoreDetail")}</p>
                  </div>
                  <div className="bg-background/50 rounded-lg p-4">
                    <p className="text-foreground mb-1 font-semibold">
                      {t("scores.analytics.twoScoresSelected")}
                    </p>
                    <p>
                      {t("scores.analytics.twoScoresDetail")}
                    </p>
                  </div>
                </div>
              </div>

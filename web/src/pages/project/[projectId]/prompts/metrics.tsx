  ...
  const columns: LangfuseColumnDef<PromptVersionTableRow>[] = [
    {
      accessorKey: "version",
      id: "version",
      header: t("prompts.metrics.version"),
      isPinnedLeft: true,
      size: 80,
      cell: ({ row }) => {
    ...
    },
    {
      accessorKey: "labels",
      id: "labels",
      header: t("prompts.metrics.labels"),
      isPinnedLeft: true,
      size: 160,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      size: 150,
      headerTooltip: {
        description: t("prompts.metrics.usageDateRangeHint"),
      },
      cell: ({ row }) => {
      ...
      ? combinedData.map((prompt) => {
          return {
            ...
            lastUsed:
              ...
              t("prompts.metrics.noLinkedGenerationYet"),
            firstUsed:
  ...
  return (
    <Page
      headerProps={{
        ...
        itemType: "PROMPT",
        help: {
          description: t("prompts.metrics.helpDescription"),
        ...
        breadcrumb: [
          ...
          { name: t("prompts.metrics.breadcrumbMetrics") },
        ],
        actionButtonsRight: (
          <DetailPageNav
            key="nav"

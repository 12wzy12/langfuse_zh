...
export default function Dataset() {
  ...
  const handleExperimentSuccess = async (data?: {
    ...
    showSuccessToast({
      title: t("datasets.experimentsPage.experimentTriggered"),
      description: t("datasets.experimentsPage.waitingForExperiment"),
      link: {
        text: t("datasets.experimentsPage.viewExperiment"),
              ...
              >
                <DialogTrigger asChild disabled={!hasExperimentWriteAccess}>
                  ...
                  >
                    ...
                    <span className="ml-2 hidden md:block">{t("datasets.experimentsPage.runExperiment")}</span>
                  </Button>
                </DialogTrigger>

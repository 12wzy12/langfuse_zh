...
export default function Dashboard() {
  ...
  const filterColumns: ColumnDefinition[] = [
    {
      name: t("home.dashboard.filters.traceName"),
      id: "traceName",
      type: "stringOptions",
      options: nameOptions,
    ...
    {
      name: t("home.dashboard.filters.tags"),
      id: "tags",
      type: "arrayOptions",
      options: tagsOptions,
      internal: "internalValue",
    ...
    {
      name: t("home.dashboard.filters.user"),
      id: "user",
      type: "string",
      internal: "internalValue",
    },
    {
      name: t("home.dashboard.filters.release"),
      id: "release",
      type: "string",
      internal: "internalValue",
    },
    {
      name: t("home.dashboard.filters.version"),
      id: "version",
      type: "string",
      internal: "internalValue",
    },
        ...
        headerProps={{
          ...
          actionButtonsLeft: (
            <>
              ...
              />
              <MultiSelect
                title={t("home.dashboard.filters.environment")}
                label={t("home.dashboard.filters.environmentShort")}

...
export default function ScoresTable({
  ...
  const scoreDeleteMutation = api.scores.deleteMany.useMutation({
    onSuccess: () => {
      showSuccessToast({
        title: t("scores.table.deleteSuccess"),
        description: t("scores.table.deleteSuccessDescription"),
      });
    },
    onSettled: () => {
  ...
  const rawColumns: LangfuseColumnDef<ScoresTableRow>[] = [
    ...
    {
      header: t("scores.table.traceName"),
    ...
    {
      header: t("scores.table.executionTrace"),
    ...
    {
      header: t("scores.table.observation"),
    ...
    {
      header: t("scores.table.environment"),
    ...
    {
      header: t("scores.table.user"),
      accessorKey: "userId",
      headerTooltip: {
        description: t("scores.table.userTooltip"),
    ...
    {
      header: t("scores.table.timestamp"),
    ...
    {
      header: t("scores.table.dataType"),
    ...
    },
    {
      ...
      headerTooltip: {
        description: t("scores.table.metadataTooltip"),
        ...
        return (
          <div className="flex items-center space-x-2">
            <Avatar className="h-7 w-7">
                src={image ?? undefined}
                alt={name ?? t("scores.table.userAvatar")}
            </Avatar>
    ...
    {
      header: t("scores.table.evalConfigId"),
      accessorKey: "jobConfigurationId",
      headerTooltip: {
        description: t("scores.table.evalConfigTooltip"),
    ...
    {
      header: t("scores.table.traceTags"),
  ...
  const tableActions: TableAction[] = [
    ...(hasTraceDeletionEntitlement
      ? [
          {
            label: t("scores.table.deleteAction"),
            description: t("scores.table.deleteDescription"),
            accessCheck: {
              scope: "traces:delete",
            ...
            <DataTable
              ...
              noResultsMessage={
                <div className="flex flex-col items-center">
                  <span>{t("scores.table.noResults")}</span>
                  <a

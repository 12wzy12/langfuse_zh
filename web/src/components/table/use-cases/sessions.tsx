...
export default function SessionsTable({
  ...
  const addToQueueMutation = api.annotationQueueItems.createMany.useMutation({
    onSuccess: (data) => {
      showSuccessToast({
        title: t("sessions.list.addedToQueueTitle"),
        description: t("sessions.list.addedToQueueDescription", {
          queueName: data.queueName,
        }),
        link: {
          href: `/project/${projectId}/annotation-queues/${data.queueId}`,
          text: t("sessions.list.viewQueue", { queueName: data.queueName }),
        },
      });
    },
  });
  ...
  const tableActions: TableAction[] = [
    {
      ...
      label: t("sessions.list.addToAnnotationQueue"),
      description: t("sessions.list.addToAnnotationQueueDescription"),
      targetLabel: t("sessions.list.annotationQueue"),
  ...
  const columns: LangfuseColumnDef<SessionTableRow>[] = [
    ...
    },
    {
      ...
      id: "createdAt",
      header: t("sessions.list.createdAt"),
      size: 150,
      enableHiding: true,
      enableSorting: true,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      id: "sessionDuration",
      header: t("sessions.list.duration"),
      size: 130,
      enableHiding: true,
    ...
    },
    {
      ...
      header: t("sessions.list.environment"),
      id: "environment",
      size: 150,
      enableHiding: true,
    ...
    },
    {
      ...
      id: "userIds",
      header: t("sessions.list.userIds"),
      size: 200,
      enableHiding: true,
      loadingCell: <TableTextLoadingCell />,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      id: "countTraces",
      header: t("sessions.list.traces"),
      size: 100,
      headerTooltip: {
        description: t("sessions.list.tracesDescription"),
      },
      enableHiding: true,
      enableSorting: true,
      loadingCell: <TableTextLoadingCell />,
    ...
    },
    {
      ...
      id: "inputCost",
      header: t("sessions.list.inputCost"),
      size: 110,
      enableHiding: true,
      defaultHidden: true,
      enableSorting: true,
    ...
    },
    {
      ...
      id: "outputCost",
      header: t("sessions.list.outputCost"),
      size: 110,
      enableHiding: true,
      enableSorting: true,
      defaultHidden: true,
    ...
    },
    {
      ...
      id: "totalCost",
      header: t("sessions.list.totalCost"),
      size: 110,
      enableHiding: true,
      enableSorting: true,
      loadingCell: <TableTextLoadingCell />,
    ...
    },
    {
      ...
      id: "inputTokens",
      header: t("sessions.list.inputTokens"),
      size: 110,
      enableHiding: true,
      defaultHidden: true,
      enableSorting: true,
    ...
    },
    {
      ...
      id: "outputTokens",
      header: t("sessions.list.outputTokens"),
      size: 110,
      enableHiding: true,
      defaultHidden: true,
      enableSorting: true,
    ...
    },
    {
      ...
      id: "totalTokens",
      header: t("sessions.list.totalTokens"),
      size: 110,
      enableHiding: true,
      defaultHidden: true,
      enableSorting: true,
    ...
    },
    {
      ...
      id: "traceTags",
      header: t("sessions.list.traceTags"),
      size: 250,
      enableHiding: true,
      defaultHidden: true,
      loadingCell: <TableTextLoadingCell />,
        ...
        <ResizableFilterLayout>
          ...
          <div className="flex flex-1 flex-col overflow-hidden">
            <DataTable
              ...
              setRowSelection={setSelectedRows}
              help={{
                description: t("sessions.list.helpDescription"),

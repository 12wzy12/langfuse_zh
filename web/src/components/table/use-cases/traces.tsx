...
export default function TracesTable({
  ...
  const traceDeleteMutation = api.traces.deleteMany.useMutation({
    onSuccess: () => {
      showSuccessToast({
        title: t("tracing.list.deletedTitle"),
        description: t("tracing.list.deletedDescription"),
      });
    },
    onSettled: () => {
      utils.traces.all.invalidate();
  ...
  const addToQueueMutation = api.annotationQueueItems.createMany.useMutation({
    onSuccess: (data) => {
      showSuccessToast({
        title: t("tracing.list.addedToQueueTitle"),
        description: t("tracing.list.addedToQueueDescription", {
          queueName: data.queueName,
        }),
        link: {
          href: `/project/${projectId}/annotation-queues/${data.queueId}`,
          text: t("tracing.list.viewQueue", { queueName: data.queueName }),
        },
      });
    },
  });
  ...
  const tableActions: TableAction[] = [
      ...
      ? [
          {
            ...
            label: t("tracing.list.deleteTraces"),
            description: t("tracing.list.deleteTracesDescription", {
              count: displayCount,
            }),
            accessCheck: {
              scope: "traces:delete",
      ...
      : []),
    {
      ...
      label: t("tracing.list.addToAnnotationQueue"),
      description: t("tracing.list.addToAnnotationQueueDescription"),
  ...
  const columns: LangfuseColumnDef<TracesTableRow>[] = [
        ...
        ] satisfies LangfuseColumnDef<TracesTableRow>[])),
    {
      ...
      header: t("tracing.list.timestamp"),
      id: "timestamp",
      size: 150,
      enableHiding: true,
      enableSorting,
    ...
    },
    {
      ...
      id: "levelCounts",
      header: t("tracing.list.observationLevels"),
      size: 150,
    ...
    },
    {
      ...
      id: "totalCost",
      header: t("tracing.list.totalCost"),
      size: 130,
      loadingCell: <TableTextLoadingCell />,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: t("tracing.list.environment"),
      id: "environment",
      size: 150,
      enableHiding: true,
    ...
    },
    {
      accessorKey: "tags",
      id: "tags",
      header: t("tracing.list.tags"),
      size: 150,
      headerTooltip: {
        description: (
          <>
            {t("tracing.list.tagsDescription")}{" "}
            <a
    ...
    },
    {
      ...
      header: t("tracing.list.metadata"),
      size: 400,
      loadingCell: () => (
        <MemoizedIOTableCell
          isLoading
      ...
      headerTooltip: {
        description: (
          <>
            {t("tracing.list.metadataDescription")}{" "}
            <a
        ...
        ]),
    {
      ...
      id: "sessionId",
      header: t("tracing.list.session"),
      size: 150,
      headerTooltip: {
        description: (
          <>
            {t("tracing.list.sessionDescription")}{" "}
            <a
    ...
    {
      accessorKey: "userId",
      header: t("tracing.list.user"),
      id: "userId",
      size: 150,
      headerTooltip: {
        description: (
          <>
            {t("tracing.list.userDescription")}{" "}
            <a
    ...
    },
    {
      ...
      id: "observationCount",
      header: t("tracing.list.observations"),
      size: 120,
      headerTooltip: {
        description: t("tracing.list.observationsDescription"),
      },
      enableHiding: true,
      defaultHidden: true,
      loadingCell: <TableTextLoadingCell />,
    ...
    },
    {
      accessorKey: "version",
      id: "version",
      header: t("tracing.list.version"),
      size: 100,
      headerTooltip: {
        description: (
          <>
            {t("tracing.list.versionDescription")}{" "}
            <a
    ...
    },
    {
      accessorKey: "release",
      id: "release",
      header: t("tracing.list.release"),
      size: 100,
      headerTooltip: {
        description: (
          <>
            {t("tracing.list.releaseDescription")}{" "}
            <a
              href="https://langfuse.com/docs/observability/features/releases-and-versioning"
              target="_blank"
              rel="noopener noreferrer"
      ...
      columns: [
        {
          ...
          id: "inputCost",
          header: t("tracing.list.inputCost"),
          size: 100,
          loadingCell: <TableTextLoadingCell />,
          cell: ({ row }) => {
        ...
        },
        {
          ...
          id: "outputCost",
          header: t("tracing.list.outputCost"),
          size: 100,
          loadingCell: <TableTextLoadingCell />,
          cell: ({ row }) => {
            const cost: TracesTableRow["cost"] = row.getValue("cost");
      ...
      columns: [
        {
          ...
          id: "inputTokens",
          header: t("tracing.list.inputTokens"),
          size: 110,
          loadingCell: <TableTextLoadingCell />,
          cell: ({ row }) => {
            const value: TracesTableRow["usage"] = row.getValue("usage");
        ...
        },
        {
          ...
          id: "outputTokens",
          header: t("tracing.list.outputTokens"),
          size: 110,
          loadingCell: <TableTextLoadingCell />,
          cell: ({ row }) => {
            const value: TracesTableRow["usage"] = row.getValue("usage");
        ...
        },
        {
          ...
          id: "totalTokens",
          header: t("tracing.list.totalTokens"),
          size: 110,
          loadingCell: <TableTextLoadingCell />,
          cell: ({ row }) => {
            const value: TracesTableRow["usage"] = row.getValue("usage");
